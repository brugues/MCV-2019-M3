...
MODEL_FNAME = '/home/grupo01/mcv/models/Josep/adam.h5'
...
print(model.summary())
plot_model(model, to_file='adam.png', show_shapes=True, show_layer_names=True)
